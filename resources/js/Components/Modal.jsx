...
export default function Modal({
    ...
    return (
        <Transition show={show} leave="duration-200">
            <Dialog as="div" id="modal" className="fixed inset-0 z-50 flex transform items-center justify-center overflow-y-auto px-4 py-6 transition-all sm:px-0" onClose={close}>
                <TransitionChild
                ...
                >
                    <DialogPanel className={`mb-6 transform overflow-hidden rounded-2xl glass-strong transition-all sm:mx-auto sm:w-full ${maxWidthClass}`}>
                        {children}
                    </DialogPanel>
                </TransitionChild>
            </Dialog>
